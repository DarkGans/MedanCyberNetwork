...
echo
sleep 2
if [$me"PASSWORD" = Dark4127 ]
then
fi
echo
echo $pur"                  @@@@@@@@@@@@@@@@@@@@@@@@@@@@@"$cy"@@@@@@@@@@@@@@@@@@@@@@"
echo $i"                   @"   $pu"   AUTHOR    :  DarkGans4127  "$i"                  @"
echo $i"                    @"  $pu"  WhatsApp  :  089613616928  "$i"                 @ "
echo $i"                     @" $pu" GMAIL     :  MISS          "$i"                @  "
echo $i"                    @"  $pu"  YOUTUBE   :  MCN OFFICIAL  "$i"                 @ "
echo $i"                   @"   $pu"   INSTAGRAM :  @wayy2308     "$i"                  @"
echo $pur"                   @@@@@@@@@@@@@@@@@@@@@@@@@@@@@"$cy"@@@@@@@@@@@@@@@@@@@@@@"
echo
echo $cy"TOOLS NYA CMN SEGINI NGNTOT:"
...
echo $ku"["$me"14"$ku"]"$i"[#]TOOLS BOKEP TERBARU[#]"
echo $ku"["$ne"15"$ku"]"$i" SPAM WHATSAPP"
echo $i"["$me"99"$i"]"$ku" EXIT"
echo
echo $pur"Masukan Pilihan Anda>>"$pur"]"
read -p"lolcalhost@DarkGans>>> " pil

if [ $pil = 1 ]
then
clear
figlet -f slant "LOANJING"|lolcat
sleep 1
...
sleep 2
echo $ku"Facebook :"$i" DarkGans"
echo $ku"YouTube  :"$i" YouTube MCN"
echo $ku"WhatsApp :"$i" 089613616928"
sleep 2
echo $pur"Terima kasih Yang Sudah Support dengan Tools ini"
sleep 2
echo $pur"SUBSCRIBE MY CHANNEL { YOUTUBE MCN }"
exit
fi
